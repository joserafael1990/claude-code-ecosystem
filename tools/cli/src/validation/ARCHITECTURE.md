...
## Overview
This document outlines the security validation system for Claude Code Ecosystem components (agents, commands, MCPs, settings, hooks).
...
npx claude-code-ecosystem --security-audit

# Validate specific component type
npx claude-code-ecosystem --security-audit --agent frontend-developer

# Validate specific file
npx claude-code-ecosystem --security-audit --file ./components/agents/frontend-developer.md

# Validate with verbose output
npx claude-code-ecosystem --security-audit --verbose

# Generate security report (JSON)
npx claude-code-ecosystem --security-audit --output report.json

# Validate in CI/CD mode (exit 1 on errors)
npx claude-code-ecosystem --security-audit --ci
```
...
✅ frontend-developer.md
   ...
   └─ Provenance: PASS (author: Claude Code Ecosystem Contributors)
