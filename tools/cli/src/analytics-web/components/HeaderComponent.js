...
class HeaderComponent {
  constructor(container, options = {}) {
    ...
    this.options = {
      title: options.title || 'Claude Code Ecosystem Dashboard',
      subtitle: options.subtitle || 'Real-time monitoring and analytics for Claude Code Ecosystem sessions',
      ...
      version: options.version || 'v1.0.0', // Default fallback
        ...
        <div class="header-content">
          ...
          <div class="header-right">
            ...
            ${this.options.showGitHubLink ? `
              <a href="https://github.com/joserafael1990/claude-code-ecosystem" target="_blank" class="github-link" title="Star on GitHub">
