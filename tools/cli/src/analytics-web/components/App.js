...
class App {
  ...
  async createPageComponent(page, container) {
    ...
    switch (page) {
      ...
      case 'agents':
        if (typeof AgentAnalytics !== 'undefined') {
          this.components.pages.agents = new AgentAnalytics(container, this.services);
          ...
          throw new Error('AgentAnalytics component not available. Check if components/AgentAnalytics.js is loaded.');
        }
        break;
