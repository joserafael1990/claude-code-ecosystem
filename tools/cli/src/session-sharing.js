...
class SessionSharing {
  ...
  convertToMarkdown(messages, conversationData, stats) {
    ...
    lines.push('\n---');
    lines.push('');
    lines.push('*Generated by Claude Code Ecosystem*');
  ...
  async exportSessionData(conversationId, conversationData, options = {}) {
    ...
    const exportData = {
      ...
      metadata: {
        exportTool: 'claude-code-ecosystem',
        exportVersion: require('../package.json').version || '1.0.0',
        messageLimit: messageLimit,
        description: 'Claude Code session export - can be cloned with: npx claude-code-ecosystem@latest --clone-session <url>'
      }
    };
