...
async function findAgentUrl(agentName) {
  try {
    ...
    const rootUrl = `https://raw.githubusercontent.com/joserafael1990/claude-code-ecosystem/main/components/agents/${agentName}.md`;
    ...
    const categoriesResponse = await fetch('https://api.github.com/repos/joserafael1990/claude-code-ecosystem/contents/components/agents');
    ...
    for (const item of contents) {
      if (item.type === 'dir') {
        const categoryUrl = `https://raw.githubusercontent.com/joserafael1990/claude-code-ecosystem/main/components/agents/${item.name}/${agentName}.md`;
        try {
