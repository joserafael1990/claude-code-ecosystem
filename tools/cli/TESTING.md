# Testing Guide for claude-code-ecosystem

This guide explains how to test the `claude-code-ecosystem` CLI tool before publishing.
...
claude-code-ecosystem --help
claude-code-ecosystem --version
claude-code-ecosystem --dry-run
claude-code-ecosystem --language javascript-typescript --framework react --yes
claude-code-ecosystem --language common --yes

# Test in different directories
mkdir test-project && cd test-project
claude-code-ecosystem --language javascript-typescript --framework vue --yes
ls -la  # Check created files

# Cleanup
npm unlink -g claude-code-ecosystem
```
...
1. **Interactive Flow**: Start `claude-code-ecosystem` without flags and go through the full interactive setup
...
npx claude-code-ecosystem@latest --version
npx claude-code-ecosystem@latest --help
```
...
claude-code-ecosystem --language javascript-typescript --framework react --dry-run --yes --verbose
```
