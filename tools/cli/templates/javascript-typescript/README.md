# JavaScript/TypeScript Ecosystem Templates
...
npx claude-code-ecosystem --language javascript-typescript
```
...
- **Main Project**: [Claude Code Ecosystem](../README.md)
...
**Ready to supercharge your JavaScript/TypeScript development?** Run `npx claude-code-ecosystem --language javascript-typescript` in your project now!