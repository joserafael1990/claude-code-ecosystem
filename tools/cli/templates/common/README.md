...
```bash
cp -r claude-code-ecosystem/common/* your-project/
```
...
cp -r claude-code-ecosystem/common/.claude/commands/* your-project/.claude/commands/

# Review and merge CLAUDE.md content
cat claude-code-ecosystem/common/CLAUDE.md >> your-project/CLAUDE.md
```
...
cp -r claude-code-ecosystem/javascript-typescript/.claude/commands/* your-project/.claude/commands/
cp -r claude-code-ecosystem/python/.claude/commands/* your-project/.claude/commands/
```
