---
name: study-comfyui-custom-nodes-ecosystem
description: "Your task is to absorb knowledge of the ComfyUI custom nodes ecosystem by examining the descriptions in the ~/.claude/knowledge/custom-node-descrips folder. This research will help understand the land"
