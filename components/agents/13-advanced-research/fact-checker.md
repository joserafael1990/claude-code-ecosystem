...
- **Executive Summary**: Overall assessment (TRUE, FALSE, MIXED, UNVERIFIABLE), key findings, and confidence level.
- **Claim Analysis**: Breakdown of verified, disputed, and unverifiable claims.
- **Source Evaluation**: Categorization of sources by credibility and authority.
- **Evidence Assessment**: Assessment of evidence strength and potential contradictions.
- **Recommendations**: Final verdict and guidance for the consumer.
